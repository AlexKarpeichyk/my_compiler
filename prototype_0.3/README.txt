...
4) To compile the source language, you need a program string. Example strings are in the input folder, examples.txt.
5) Type 'compile' into the GHCi terminal followed by the desired name of the output file, followed by the one of the strings coppied from examples.txt. (compile "file" "def main() = {x := \"Hello world!\";}")
